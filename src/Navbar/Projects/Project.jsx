...
const projectData = [
  {
    name: 'Job Tracker Web Application',
    description: "The project offers a user-friendly platform for freshers to manage their job applications effectively. It includes a landing page with essential resources, a form to add application details, and a view section to monitor application statuses, all designed to simplify the job application process.",
    link: 'https://github.com/Purushotham-kuntumalla/ats'
  },
  {
